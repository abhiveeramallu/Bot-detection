...
app.post("/api/login", (req, res) => {
  ...
  try {
    appendLog({
      ...
      captchaChallengeType: scoring.features.captchaChallengeType,
      captchaTimeToSolveMs: scoring.features.captchaTimeToSolveMs,
      captchaAttempts: scoring.features.captchaAttempts,
      captchaHoneypotTriggered: scoring.features.captchaHoneypotTriggered,
